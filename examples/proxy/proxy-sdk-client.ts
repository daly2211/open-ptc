/**
 * Open-PTC Proxy Client Example — Using OpenAI SDK
 *
 ...
 *   - LiteLLM running
 *
 * Run: deno run --allow-net --allow-env examples/proxy/proxy-sdk-client.ts
 */
...
async function main() {
  console.log("=== Proxy + OpenAI SDK Example ===\n");
  ...
  // Handle tool calls until there are none left
